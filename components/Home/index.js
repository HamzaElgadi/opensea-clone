...
const style = {
  ...
  creator: `text-sm font-medium text-white-500 text-white`,
  creatorName: `cursor-pointer text-blue-500 text-white`,
  verified: `h-5 w-5 text-white-500 text-white`,
  descriptionContainer: `max-w-3xl py-2 px-10 text-center text-white-500 text-white`,
}
